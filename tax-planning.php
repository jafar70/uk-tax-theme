...
<head>
  ...
  <title>Tax Planning | UK Tax LTD</title>
...
<body>
    ...
    <div class="head-container">
      ...
      <div id='button' class='menu button'></div>
        <ul id='nav' class="nav__links">
          ...
          <li class='current-menu-item'><a href="tax-planning.php">Tax Planning </a></li>
  ...
  <div class="page-banner" style='background: linear-gradient(0deg, rgba(255, 255, 255,0.8), rgba(255, 255, 255,0.8)),url(assets/img/page-banner.jpeg)'>
    <h1 class="page-banner__title">Tax Planning</h1>
  </div>
  <div class="breadcrumb">
    <div class="container">
      <a href="/">Home</a> > <a href="#!">Tax Planning</a> 
    </div>
  </div>
  
  <section class="full-width-text">
    <div class="container">
      <h2 class='underline'>Need help with your taxes</h2>
      <p>Wishing to streamline your business, recoup costs and make wise decisions on your tax are all things we frequently discuss with clients just like you. Our accountancy team are fully qualified and the experts when it comes to tax planning. We can conduct a full tax review of your business and determine the most efficient tax structure for you.</p>
      <p>
        <ul>
          <li>VAT – Value Added Tax</li>
          <li>Personal Income Tax (Self-Assessment/Tax Return)</li>
          <li>Corporation Tax</li>
          <li>PAYE, NIC &amp; CIS Tax</li>
        </ul>
      </p>
      <p>First and foremost we always aim to forge successful and lasting relationship with our clients, but ultimately our strategy is to work with our clients to create value for money, financial management and tax planning services. These will be tailored to meet your requirements and play a leading role in the safeguarding of your assets and income.<br>
      Our clients rely on us not just for basic bookkeeping and accounts preparation, but as an indispensable element of their business. We want you to get the best deal possible from the UK tax system, and our accountants are here to help you find it.</p>
    </div>
  </section>
