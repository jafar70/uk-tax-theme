...
<head>
  ...
  <title>Contact Us | UK Tax LTD</title>
...
<body>
  ...
  <section class="full-width-text">
    <div class="container">
      <h2 class='underline'>Contact Details</h2>
      <p>We recently helped a small business grow from break-even to over $1m profit in less than 2 years. Have a general question concerning fortune, but don't know who to contact? Please find below contact details and contact us today!</p>
    </div>
    <div class="contact-details">
    <div class="contact-details__grid container">
      <div class="contact-details__grid__item">
        <div class="contact-details-col">
          <h3>Main Office</h3>
          <ul class="contact-details-col__list footer__grid__item__contact_list">
             <li><span class="icon icon-clock"></span><b>Address:</b> 119 Rose Lane, Romford, RM6 5NR</li>
             <li><span class="icon icon-phone"></span><b>Call Us:</b> 02085990003(Telephone)<br> 07979203598(Mobile)</li>
             <li><span class="icon icon-paper-plane"></span><b>Mail Us:</b> vika.accts@gmail.com</li>
            <li><span class="icon icon-clock"></span><b>Opening Time:</b> Mon - Fri: 9:30am - 19:30pm</li>
           </ul>
        </div>
      </div>
      <div class="contact-details__grid__item">
   ...
   <div class="contact-details-2">
     <div class="contact-details-2__grid container">
       <div class="contact-details-2__grid__item">
         <h2 class='underline'>Feel Free to Contact Us via the form bellow</h2>
        <form action="" class="form row">
          ...
          <div class="form__col-50">
            <input type="text" name="subject" value="" size="40" class="input-text" id="subject" placeholder="Subject">
          </div>
