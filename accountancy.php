...
<head>
  ...
  <title>Accountancy | UK Tax LTD</title>
...
<body>
    ...
    <div class="head-container">
      ...
      <div id='button' class='menu button'></div>
        <ul id='nav' class="nav__links">
          ...
          <li class='current-menu-item'><a href="accountancy.php">Accountancy </a></li>
  ...
  <div class="page-banner" style='background: linear-gradient(0deg, rgba(255, 255, 255,0.8), rgba(255, 255, 255,0.8)),url(assets/img/page-banner.jpeg)'>
    <h1 class="page-banner__title">Accountancy</h1>
  </div>
  <div class="breadcrumb">
    <div class="container">
      <a href="/">Home</a> > <a href="#!">Accountancy</a> 
    </div>
  </div>
  
  <section class="full-width-text">
    <div class="container">
      <h2 class='underline'>Do you need accountancy services?</h2>
      <p>We offer a complete service for all accountancy services. If you’re starting up a small business or incorporating a company, our accountants are here to help. We’ve helped hundreds of clients set up new businesses from day one. We’ll register your company for PAYE, VAT and/or CIS, complete the incorporation and guide you through the first steps on your business journey. From Public Limited Company to sole trader, our accountants are here to advice on the best way of setting up your business.</p>
      <p>
        <ul>
          <li>Self-Assessments /Tax Returns</li>
          <li>Bookkeeping</li>
          <li>PAYE/CIS (Construction Industry Scheme)</li>
          <li>Cashflow Predictions</li>
          <li>Business Restructuring</li>
          <li>Budgeting</li>
          <li>Company Accounts preparation</li>
        </ul>
      </p>
      <p>We provide a cost-effective, high value solution to meet all of your financial needs. We work hard to get to know you in order to deliver timely, individual advice on how to improve your business and personal wealth. Whether it’s one-off advice or a long-term partnership you need, we’re here to help. Whatever your needs, you will receive an excellent level of accountancy service.</p>
    </div>
  </section>
